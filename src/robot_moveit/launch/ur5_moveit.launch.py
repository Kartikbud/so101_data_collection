...
def generate_launch_description():
    ...
    moveit_config = (MoveItConfigsBuilder("ur5", package_name="robot_moveit")
        ...
        .robot_description_kinematics(file_path="ur5_config/kinematics.yaml")
        .joint_limits(file_path="ur5_config/joint_limits.yaml")
        .pilz_cartesian_limits(file_path="ur5_config/pilz_cartesian_limits.yaml")
