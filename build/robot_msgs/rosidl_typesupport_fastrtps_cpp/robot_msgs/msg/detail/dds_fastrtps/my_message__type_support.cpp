...
#include "robot_msgs/msg/detail/my_message__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_msgs::msg::MyMessage & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_msgs::msg::MyMessage & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_msgs::msg::MyMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_msgs::msg::MyMessage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_msgs::msg::MyMessage *>(
    untyped_ros_message);
...
{
  return &robot_msgs::msg::typesupport_fastrtps_cpp::_MyMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_msgs, msg, MyMessage)() {
  return &robot_msgs::msg::typesupport_fastrtps_cpp::_MyMessage__handle;
}
